...
async function callAI(
  ...
  // ââ Cortesia Gemini â proxy SSE customizado ââââââââââââââââââââââââââââââ
  if (provider.type === "cortesia") {
    ...
    // No web (React Native Web no browser), o ReadableStream Ã s vezes nÃ£o funciona;
    // usamos response.text() como fallback confiÃ¡vel.
...
8. PLANO DE EXECUÃÃO: Para tarefas grandes, liste os passos numerados e peÃ§a confirmaÃ§Ã£o para comeÃ§ar. Depois execute passo a passo dando feedback de cada um.`;
  ...
  return (
    ...
    >
          ...
          <View style={styles.emptyChat}>
            ...
            <Text style={[{ color: colors.mutedForeground, fontSize: 12, textAlign: "center", marginBottom: 16 }]}>
              {activeFile
                ...
                : "Toque em uma sugestÃ£o ou escreva sua pergunta"}
            </Text>
            {/* Chips de sugestÃ£o */}
      ...
      {/* Chips de resposta rÃ¡pida (aparecem apÃ³s a IA responder) */}
      ...
      {/* Atalhos de geraÃ§Ã£o (modo Dev + projeto ativo) */}
      ...
      <View style={[styles.inputRow, { backgroundColor: colors.card, borderTopColor: colors.border }]}>
        ...
        <TextInput
          ...
          placeholder="Pergunte, peÃ§a ajuda, diga OK..."
          placeholderTextColor={colors.mutedForeground}
          multiline
          maxLength={4000}
